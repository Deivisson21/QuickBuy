...
{
    public partial class pVersaoBD : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Senha = table.Column<string>(maxLength: 1000, nullable: false),
                    Nome = table.Column<string>(maxLength: 500, nullable: false),
                    SobreNome = table.Column<string>(maxLength: 500, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EnderecoCompleto = table.Column<string>(maxLength: 500, nullable: false),
                    NumeroEndereco = table.Column<string>(maxLength: 11, nullable: false),
